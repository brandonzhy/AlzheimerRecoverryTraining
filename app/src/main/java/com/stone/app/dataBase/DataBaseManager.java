...
public class DataBaseManager {
    ...
    // Used to display the amount of one's relation
    // Act as an assistant to draw the local focused family member relation tree
    public static final class RelationStrengthIndex {
        public String myID;
        public boolean married;
        public int parentAmount;
        public int siblingAmount;
        public int childAmount;
        public int oneselfAmount;
        public int predecessorAmount;
    }

    // Used to draw the local focused family member relation tree
    public static final class RelationRadiationChart {
        public RelationStrengthIndex spouse;
        public List<RelationStrengthIndex> parentList;
        public List<RelationStrengthIndex> siblingList;
        public List<RelationStrengthIndex> childList;
        public List<RelationStrengthIndex> oneselfList;
        public List<RelationStrengthIndex> predecessorList;
    }
    ...
    public synchronized FamilyData AddFamily(String name, String memberID)
            throws DataBaseError {
        ActivateDataBase();
        try {
            return dm.AddFamily(Manager, name, memberID);
        } finally {
            CloseDataBase();
        }
    }
    ...
    public synchronized MemberData AddMember(String nickname, String password, String familyID,
        ...
        ActivateDataBase();
        try {
            return dm.AddMember(Manager, nickname, password, familyID, name, gender, phone);
        } finally {
            CloseDataBase();
        }
    }
    ...
    public synchronized List<PhoneData> getPhoneList(String phone, String memberID) throws DataBaseError {
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getPhoneList : NoRequiredResultsFound ");
    ...
    public synchronized List<FamilyData> getFamilyList(String ID, String name, String rootMemberID) throws DataBaseError {
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getFamilyList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<MemberData> getMemberList(String ID, String familyID, String name, String nickname) throws DataBaseError {
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getMemberList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<MemberRelationData> getMemberRelationList(String member, int relation) throws DataBaseError {
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getMemberRelationList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<GameRecordData> getGameRecordList(String recordID, String memberID, int gameType,
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getGameRecordList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<PictureData> getPictureList(String ID, String name, String memberID,
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getPictureList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<ThirdPartyAccountData> getThirdPartyAccountList(String memberID, String account, int thirdPartyType) throws DataBaseError {
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getThirdPartyAccountList : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<PictureData> getRandomPicturesFromMember(String memberID, String name, String location,
        ...
        try {
            ...
            if(null == l) {
                Log.i("TAG", "getRandomPicturesFromMember : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized List<PictureData> getRandomPicturesFromFamily(String familyID, String name, String location,
        ...
        ActivateDataBase();
        try {
            List<PictureData> l = dm.getRandomPicturesFromFamily(Manager, familyID, name, location, dateBegin, dateEnd, amount);
            if(null == l) {
                Log.i("TAG", "getRandomPicturesFromFamily : NoRequiredResultsFound ");
                throw new DataBaseError(DataBaseError.ErrorType.RequiredResultsReturnNULL);
            }
            else return l;
        } finally {
    ...
    public synchronized void UpdateFamily(String ID, String name, String rootMemberID)
            throws DataBaseError, DataBaseSignal {
        ActivateDataBase();
        try {
            dm.UpdateFamily(Manager, ID, name, rootMemberID);
        } finally {
            CloseDataBase();
        }
    }
    ...
    public synchronized void UpdateMember(String ID, String password, int gender, String name, String nickname)
            throws DataBaseError, DataBaseSignal {
        ActivateDataBase();
        try {
            dm.UpdateMember(Manager, ID, password, gender, name, nickname);
        } finally {
            CloseDataBase();
        }
    }
