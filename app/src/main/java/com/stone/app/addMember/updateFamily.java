...
//                    updateFamilyItem.setRightImagepath(familyData.ge());
                ...
                updateFamilyItem2.setRightText(familyData.getName());
                ...
                updateFamilyItem.setRightText(String.valueOf(dataBaseManager.getMemberList("", familyID,"","").size()));
